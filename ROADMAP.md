...
> [!IMPORTANT]
> 当前版本为 `0.1.0-alpha.18`，处于 **M3 安全试点准备**。M1 本地工作流与 M2 受控操作已经完成；M0 中安装后操作系统身份隔离仍未关闭。能够保存真实凭据、执行固定 PostgreSQL 检查或生成自检报告，均不等于已经适合生产使用。
...
2. 先完成 alpha.19 三平台安装身份与 IPC 证据，不直接修改公开身份状态；
