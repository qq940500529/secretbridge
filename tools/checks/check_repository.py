...
REQUIRED = (
    ...
    "docs/README.md",
    "docs/user-guide/使用指南.md",
    "docs/development/开发者入门.md",
    "docs/governance/依赖许可风险评估.md",
    "docs/governance/贡献与再许可.md",
    "docs/release/发行物验证与SBOM.md",
    "docs/release/依赖漏洞与发行门槛.md",
    "docs/testing/自动化安全验收.md",
    ...
    "pnpm-workspace.yaml",
    "rust-toolchain.toml",
    "tools/checks/check_dependency_licenses.py",
    "tools/release/verify_reproducible_packages.py",
...
def check_repository(root: Path) -> list[str]:
    ...
    for directory, folders, files in os.walk(root, topdown=True, followlinks=False):
        folders[:] = sorted(folder for folder in folders if folder not in SKIP_PARTS)
