...
| 安全连续终端与实时状态 | [安全连续终端](AI终端与实时状态.md) |
| 为 AI 客户端安装操作 Skill | [AI 操作 Skill 与 MCP 职责](AI操作Skill.md) |
| 迁移、备份和恢复 | [配置迁移与备份恢复](配置迁移与备份恢复.md) |
| 参与真实环境测试 | [Beta 测试与反馈](Beta测试与反馈.md) · [社区验证待办](社区验证待办.md) |
...
| 维护 Skill 与 MCP 契约 | [AI 操作 Skill 与 MCP 职责](AI操作Skill.md) |
