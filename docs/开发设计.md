...
| `catalog/schema.rs` | 新数据库的 schema 20 创建逻辑 |
...
`secretbridge-core::SCHEMA_VERSION` 是 schema 的唯一事实源，当前值为 20。当前开发版不承诺兼容早期未发布数据库；恢复只写入新的绝对目录。公开 Beta 之间的兼容范围以对应 Release 说明为准。
