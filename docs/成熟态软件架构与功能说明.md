...
本文描述 SecretBridge 开源版的成熟目标形态，用于约束后续功能开发。当前实现范围以[开源版路线图](../ROADMAP.md)为准；未来闭源商业企业版与当前仓库的差异见[开源版与企业版产品边界](开源版与企业版.md)。
...
当前开源版不是云端密码库、合规审计平台或团队审批系统，面向单人、本机、AI 辅助运维和开发场景。这些组织级能力属于未来独立企业版，不作为开源版成熟度缺口。
...
- 团队、多租户、集中治理和远程代理属于未来独立企业版，不进入开源版本路线图；
- 开源版不为制造商业差异而限制单用户本机核心能力，版本差异来自协作、治理、规模和服务保障。

---

[开源版路线图](../ROADMAP.md) · [开源版与企业版](开源版与企业版.md) · [当前开发设计](开发设计.md) · [安全模型](安全模型与验收.md) · [跨平台与 UI 规范](跨平台与UI规范.md)
