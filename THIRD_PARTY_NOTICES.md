...
| totp-rs 6.0.0 and its QR/image dependencies | RFC 6238 TOTP generation, validation and enrollment QR rendering; MIT | Preserve applicable license texts and include the resolved components in release SBOMs |
