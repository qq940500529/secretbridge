...
| reqwest 0.13.5 | Authenticated loopback client for the detached MCP bridge, MIT OR Apache-2.0 | Default features are disabled and only JSON support is enabled; record the selected license path and preserve applicable terms and notices |
| base64 0.23.1 / tower-http 0.6.11 | Transitive Reqwest runtime dependencies, MIT OR Apache-2.0 / MIT | Keep version-specific notices in generated distribution inventories; these may coexist with other resolved versions |
