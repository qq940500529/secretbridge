...
For maintainer decisions, see [open-source governance](./docs/governance/开源治理.md) and the [dependency license assessment](./docs/governance/依赖许可风险评估.md). The latter reviews current direct dependencies and future candidates; it is not a legal opinion or an audit of every transitive dependency and release binary.
